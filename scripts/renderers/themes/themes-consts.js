...
const curriedGetStyleDictionaryConfig = curry(getStyleDictionaryConfig);
const baseConfig = curriedGetStyleDictionaryConfig(__, 'main');
const alternateConfig = curriedGetStyleDictionaryConfig(__, 'alternate');
